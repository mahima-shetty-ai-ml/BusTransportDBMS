...
if(isset($_POST['searchdestination'])){
   ...
   $sql = "SELECT a.bus_no, a.booking_no, a.passenger_name, a.source, a.date_source, a.time_source, a.destination, a.date_destination, a.time_destination, a.fare, b.bus_reg, b.driver_name, b.conductor_name FROM bus_management a, businfo b WHERE a.bus_no=b.bus_no and date_destination = '$searchdestination';";
...
<body>
    ...
    <div class="content">
        ...
        <div class = "formbeautify"> 
            ...
            <form action="searchdestination.php" method="post">
                <label for="searchdestination">Select a Destination Date:</label>
                <input type="date" id="searchdestination" name="searchdestination">
