...
if(isset($_POST['searchsource'])){
   ...
   $searchsource = $_POST["searchsource"];
   ...
   $sql = "SELECT a.bus_no, a.booking_no, a.passenger_name, a.source, a.date_source, a.time_source, a.destination, a.date_destination, a.time_destination, a.fare, b.bus_reg, b.driver_name, b.conductor_name FROM bus_management a, businfo b WHERE a.bus_no=b.bus_no and date_source = '$searchsource';";
...
<body>
    ...
    <div class="content">
        ...
        <div class = "formbeautify"> 
            ...
            <form action="searchsource.php" method="post">
                <label for="searchsource">Select a Source Date:</label>
                <input type="date" id="searchsource" name="searchsource">
