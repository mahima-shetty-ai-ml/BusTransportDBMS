...
if(isset($_POST['searchbus'])){
   ...
   $sql = "SELECT a.bus_no, a.booking_no, a.passenger_name, a.source, a.date_source, a.time_source, a.destination, a.date_destination, a.time_destination, a.fare, b.bus_reg, b.driver_name, b.conductor_name FROM bus_management a, businfo b WHERE a.bus_no = b.bus_no and a.bus_no = $searchbus;";
    ...
    <div class="content">
        ...
        <div class = "formbeautify"> 
            ...
            <form action="searchbus.php" method="post">
                <label for="searchbus">Bus No.</label>
                <input type="text" id="searchbus" name="searchbus" placeholder="Enter bus no...">
