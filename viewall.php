...
//    $searchdestination = $_POST["searchdestination"];
   ...
   $sql = "SELECT a.bus_no, a.booking_no, a.passenger_name, a.source, a.date_source, a.time_source, a.destination, a.date_destination, a.time_destination, a.fare, b.bus_reg, b.driver_name, b.conductor_name FROM bus_management a, businfo b WHERE a.bus_no=b.bus_no;";
...
<body>
    ...
    <div class="content">
        ...
        <div class="selectnext" style="width: 100%; ">
            <a href="viewall.php" style="width: 100.00%; color: white;">VIEW ALL PASSENGERS</a>
            <a href="viewbus.php" style="width: 100.00%; color: white;" >VIEW ALL BUSES</a>
